...
> Yazıldıktan hemen sonra `node scripts/dogrula-plan.mjs <bu-dosya>` çalıştırılır. Doğrulayıcı Bölüm A ile Bölüm C tablolarını karşılaştırır, o yüzden iki tablonun da makine tarafından okunabilir kalması gerekir: iş numaraları sayı, "İşler" sütunu virgülle ayrılmış numara listesi, "YAZACAĞI dosyalar" sütunu virgülle ayrılmış dosya yolu listesi.
