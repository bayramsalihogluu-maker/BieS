...
> Yazmadan önce iki komut çalıştırılır: `node scripts/rapor-birlestir.mjs` (Bölüm B'nin ham gövdesini SONUC.md dosyalarından kurar) ve `node scripts/izolasyon-kontrol.mjs` (Bölüm E'yi git üzerinden ölçer). Bu iki bölüm hafızadan yazılmaz.
